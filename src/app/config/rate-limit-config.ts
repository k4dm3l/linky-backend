...
export const rateLimitSettings: RateLimitSettings = {
  ...
  strict: {
    ...
    message: process.env.RATE_LIMIT_STRICT_MESSAGE || "Too many requests from this IP, please try again later.",
  },
  auth: {
    ...
    message: process.env.RATE_LIMIT_AUTH_MESSAGE || "Too many authentication attempts, please try again later.",
  },
}; 