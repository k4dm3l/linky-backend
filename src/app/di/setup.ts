...
export function setupContainer(): Container {
  ...
  container.registerSingleton("transactionManager", () => new InMemoryTransactionManager());

  // Register infrastructure services
  container.registerSingleton("rateLimitService", () => new ExpressRateLimitService());

  // Register repositories
  container.registerSingleton("userRepository", () => new InMemoryUserRepository());
  container.registerSingleton("userCredentialsRepository", () => new InMemoryUserCredentialsRepository());

  // Register domain services
  container.registerSingleton("userDomainService", () => 
