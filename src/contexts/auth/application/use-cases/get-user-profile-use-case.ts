...
} from "@/contexts/auth/application/queries/get-user-profile-query";
import {
  AuthResult,
  AuthResultBuilder,
...
export class GetUserProfileUseCase {
  ...
  async execute(
  ...
  ): Promise<AuthResult<GetUserProfileQueryResult>> {
    let transaction: any;
    ...
    try {
      ...
      try {
        ...
        if (!user) {
          return AuthResultBuilder.error("User not found", "USER_NOT_FOUND");
        }
